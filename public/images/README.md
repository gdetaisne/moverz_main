# Guide des Images Moverz Marseille

## 📁 Structure des Répertoires

```
public/images/
├── hero/              # Hero section - mockup IA + Marseille
...
### 4. Quartiers Marseille (2 images minimum, format 16:9 ou 4:3)
...
- **blog/cover-guide-marseille.jpg** - Vue Marseille générique
...
<Image
  ...
  alt="Estimation de volume en m³ à partir de photos — déménagement à Marseille"
  fill
  priority
...
- ✅ `"Cartons étiquetés et protégés — déménagement professionnel Marseille"`
...
**Maintenue par**: Équipe Moverz Marseille
