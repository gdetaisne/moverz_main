# Guide des Images Moverz lyon

## 📁 Structure des Répertoires

```
public/images/
├── hero/              # Hero section - mockup IA + lyon
...
- **hero/hero-ai-mockup.jpg** (16:9, ≤150KB)
  ...
  - Collage lyon en filigrane (Place de la Bourse, Garonne)
...
### 4. Quartiers lyon (2 images minimum, format 16:9 ou 4:3)
...
- **blog/cover-guide-lyon.jpg** - Vue lyon générique
...
#### Exemples
- ✅ `"Estimation de volume en m³ à partir de photos — déménagement à lyon"`
- ✅ `"Chartrons — accès camion déménagement, façades typiques, rues étroites"`
- ✅ `"Cartons étiquetés et protégés — déménagement professionnel lyon"`
...
**Maintenue par**: Équipe Moverz lyon
