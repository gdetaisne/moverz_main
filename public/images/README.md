# Guide des Images Moverz rouen

## 📁 Structure des Répertoires

```
public/images/
├── hero/              # Hero section - mockup IA + rouen
...
- **hero/hero-ai-mockup.jpg** (16:9, ≤150KB)
  ...
  - Collage rouen en filigrane (Place de la Bourse, Garonne)
...
### 4. Quartiers rouen (2 images minimum, format 16:9 ou 4:3)
...
- **blog/cover-guide-rouen.jpg** - Vue rouen générique
...
<Image
  ...
  alt="Estimation de volume en m³ à partir de photos — déménagement à rouen"
  fill
  priority
...
- ✅ `"Cartons étiquetés et protégés — déménagement professionnel rouen"`
...
**Maintenue par**: Équipe Moverz rouen
