  ...
  return (
    <footer className="mt-24 border-t border-white/10 bg-white/5">
      <div className="container max-w-7xl mx-auto px-4 md:px-6 py-14 grid md:grid-cols-4 gap-10">
        <div>
          <div className="text-lg font-semibold">Déménageurs Thairé d'Aunis (IA)</div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/90">
            ...
            <li><Link href="/thaire-daunis" className="hover:text-white">Zones desservies</Link></li>
      ...
      <div className="pb-10 text-center text-xs text-white/50">© {new Date().getFullYear()} Déménageurs Thairé d'Aunis</div>
    </footer>
  );
}
