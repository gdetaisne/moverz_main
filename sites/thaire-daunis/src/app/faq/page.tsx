...
const faqs: QA[] = [
  ...
  {
    q: "Combien de cartons prévoir pour un déménagement ?",
    a: [
  ...
  {
    q: "Dois-je demander une autorisation de stationnement ?",
    a: [
      "Dans la plupart des grandes villes, oui. Pour réserver un emplacement de déménagement, faites une demande d'occupation exceptionnelle de l'espace public auprès de votre mairie, de préférence en ligne et quelques jours à l'avance. En secteur piéton, l'accès peut être régulé. Votre déménageur peut souvent s'en charger."
    ],
    category: "Prestations & logistique",
  },
  {
  ...
  {
    q: "Quels sont les zones les plus complexes pour déménager ?",
    a: [
      "Les déménagements sont généralement plus délicats dans les hypercentres piétons où l'accès est régulé par des bornes et les livraisons se font sur des créneaux autorisés. Les zones avec rues étroites, stationnement difficile ou escaliers nombreux nécessitent aussi plus de préparation. Anticipez l'autorisation de stationnement."
    ],
    category: "Prestations & logistique",
  },
  // Tarifs & paiement
  ...
  {
    q: "Quel est le prix moyen d'un déménagement ?",
    a: [
      "Selon les données des comparateurs professionnels, un déménagement de 20 m³ coûte en moyenne ~890-1 040 € en local (<100 km) et 1 710-1 960 € en longue distance. Pour un T3, on observe souvent 1 000-1 300 € en local, et 1 700-2 000 € au-delà de 500 km. Le prix exact dépend du volume, de la distance, de l'accès (ascenseur, stationnement) et de la formule choisie."
    ],
    category: "Tarifs & paiement",
  },
  {
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="absolute inset-0">
          <img 
            ...
            alt="FAQ Déménagement {cityData.city_name} - Questions fréquentes"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              FAQ — Déménagement à {cityData.city_name}
            </h1>
            <p className="text-lg md:text-xl text-white/90">
              Vous trouverez ici les réponses aux questions les plus fréquentes. Pour un chiffrage précis, utilisez notre estimation en ligne.
            </p>
          </div>
        </div>
      </section>
                      ...
                      <div className="mt-3 space-y-3 text-white/85">
                        ...
                        {item.q.includes("estimer le volume") && (
                          <p className="text-sm text-white/70">
                            Lancez votre{" "}
                            <a className="underline text-accent" href="/inventaire-ia/">estimation de déménagement</a>{" "}
                            en quelques minutes.
                          </p>
                        )}
                      </div>
