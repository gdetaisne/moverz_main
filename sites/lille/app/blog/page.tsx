...
export const metadata: Metadata = {
  title: "Blog Déménagement Lille - Guides & Conseils Experts | Moverz",
  description: "Guides complets et conseils d'experts pour réussir votre déménagement à Lille. Astuces budget, checklist, comparatifs, conseils pratiques. Articles rédigés par des professionnels.",
  alternates: {
    canonical: `https://www.devis-demenageur-lille.fr/blog`,
  },
  openGraph: {
    title: "Blog Déménagement Lille - Tous nos guides pratiques",
    description: "Conseils d'experts, guides détaillés et astuces pour déménager sereinement à Lille.",
    url: `https://www.devis-demenageur-lille.fr/blog`,
    type: 'website',
  },
}
...
const blogCategories = [
  ...
  { 
    ...
    description: 'Déménager de lille vers toute la France',
    icon: '🚛',
  ...
  { 
    slug: 'international', 
    name: 'International', 
    description: 'Déménager à l\'étranger depuis lille',
    icon: '🌍',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Blog Déménagement lille
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Conseils, guides et astuces pour réussir votre déménagement à lille. 
