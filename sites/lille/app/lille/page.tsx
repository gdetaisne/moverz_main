...
export const metadata = generateLocalPageMetadata("Lille", "Lille");

const LilleData = {
  zone: "Lille",
  zoneDisplay: "Lille",
  description: "Service professionnel de déménagement dans le centre de Lille",
  stats: {
    dossiers: "+120",
    demenageurs: "20",
    delai: "3-5"
  },
  pourquoiMoverz: "Lille se classe en tête des villes françaises où il fait bon vivre en famille avec une note de 19/20 selon Le Figaro. Notre équipe d'experts déménageurs connaît parfaitement les spécificités de la ville : rues étroites du centre historique, contraintes de stationnement, immeubles anciens avec escaliers. Nous vous accompagnons dans votre projet de déménagement avec des déménageurs locaux certifiés qui maîtrisent les accès et les particularités de chaque quartier lillois.",
  accesStationnement: "Lille présente des défis spécifiques pour les déménagements : rues étroites dans le centre historique, stationnement limité, immeubles anciens avec escaliers. Nos partenaires déménageurs connaissent parfaitement les créneaux autorisés, les zones de déchargement et les contraintes de circulation. Ils s'adaptent aux gabarits de camions selon les rues et optimisent les horaires pour éviter les embouteillages.",
  ...
  partenaires: [
    ...
    {
      name: "Atlantique Lille Déménagements",
      rating: 4.5,
      reviews: 66,
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement à Lille ?",
      answer: "Nos partenaires déménageurs à Lille peuvent généralement intervenir sous 7 jours. Pour les déménagements urgents, certains peuvent se libérer en 48h selon la période."
    },
    {
      question: "Comment se déroule l'accès au logement à Lille ?",
      answer: "Nos déménageurs connaissent parfaitement les contraintes lilloises : rues étroites, stationnement limité, immeubles anciens. Ils s'adaptent aux créneaux autorisés et optimisent les horaires."
    },
    {
      question: "Quels sont les tarifs pour un déménagement à Lille ?",
    ...
    },
    {
      ...
      answer: "Tous nos partenaires déménageurs à Lille sont certifiés et assurés. Nous vérifions régulièrement leur couverture d'assurance et leur qualité de service."
    },
    {
      question: "Peut-on déménager le week-end à Lille ?",
    ...
    {
      question: "Comment préparer mon déménagement à Lille ?",
