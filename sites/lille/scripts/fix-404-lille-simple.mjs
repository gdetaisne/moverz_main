...
/**
 * Correction des liens 404 dans Lille
...
// Guides principaux avec category: "demenagement-lille"
const guides = Object.values(mapping).filter(item => item.category === 'demenagement-lille');
