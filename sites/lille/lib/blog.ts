...
function cleanSlug(originalSlug: string, category: string): string {
  ...
  const cleanPatterns = [
    ...
    { from: /^demenagement-etudiant-lille-/, to: '' },
    { from: /^demenagement-entreprise-lille-/, to: '' },
    { from: /^demenagement-piano-lille-/, to: '' },
    { from: /^demenagement-international-lille-/, to: '' },
    { from: /^demenagement-longue-distance-lille-/, to: '' },
    { from: /^demenagement-pas-cher-lille-/, to: '' },
    { from: /^demenagement-urgent-lille-/, to: '' },
    { from: /^devis-demenagement-lille-/, to: '' },
    { from: /^garde-meuble-lille-/, to: '' },
    { from: /^prix-demenagement-lille-/, to: '' },
    { from: /^prix-demenagement-piano-lille-/, to: '' },
    { from: /^prix-garde-meuble-lille-/, to: '' },
    // Ensuite, retirer les patterns partiels en début
    { from: /^stockage-etudiant-lille/, to: 'stockage-etudiant' },
    { from: /^cartons-gratuits-lille/, to: 'cartons-gratuits' },
    { from: /^camion-demenagement-etudiant-lille/, to: 'camion-demenagement-etudiant' },
    { from: /^assurance-demenagement-international-lille/, to: 'assurance-demenagement-international' },
    { from: /^prix-demenagement-international-lille/, to: 'prix-demenagement-international' },
    { from: /^emballage-demenagement-international-lille/, to: 'emballage-demenagement-international' },
    { from: /^formalites-douanieres-demenagement-international-lille/, to: 'formalites-douanieres-demenagement-international' },
    // Retirer "-lille" en milieu de slug
    { from: /-lille-/, to: '-' },
    // Retirer "-lille" en fin
    { from: /-lille$/, to: '' },
