...
function cleanSlug(originalSlug: string, category: string): string {
  ...
  const cleanPatterns = [
    ...
    { from: /^demenagement-etudiant-nantes-/, to: '' },
    { from: /^demenagement-entreprise-nantes-/, to: '' },
    { from: /^demenagement-piano-nantes-/, to: '' },
    { from: /^demenagement-international-nantes-/, to: '' },
    { from: /^demenagement-longue-distance-nantes-/, to: '' },
    { from: /^demenagement-pas-cher-nantes-/, to: '' },
    { from: /^demenagement-urgent-nantes-/, to: '' },
    { from: /^devis-demenagement-nantes-/, to: '' },
    { from: /^garde-meuble-nantes-/, to: '' },
    { from: /^prix-demenagement-nantes-/, to: '' },
    { from: /^prix-demenagement-piano-nantes-/, to: '' },
    { from: /^prix-garde-meuble-nantes-/, to: '' },
    // Ensuite, retirer les patterns partiels en début
    { from: /^stockage-etudiant-nantes/, to: 'stockage-etudiant' },
    { from: /^cartons-gratuits-nantes/, to: 'cartons-gratuits' },
    { from: /^camion-demenagement-etudiant-nantes/, to: 'camion-demenagement-etudiant' },
    { from: /^assurance-demenagement-international-nantes/, to: 'assurance-demenagement-international' },
    { from: /^prix-demenagement-international-nantes/, to: 'prix-demenagement-international' },
    { from: /^emballage-demenagement-international-nantes/, to: 'emballage-demenagement-international' },
    { from: /^formalites-douanieres-demenagement-international-nantes/, to: 'formalites-douanieres-demenagement-international' },
    // Retirer "-nantes" en milieu de slug
    { from: /-nantes-/, to: '-' },
    // Retirer "-nantes" en fin
    { from: /-nantes$/, to: '' },
