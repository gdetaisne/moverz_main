  ...
  return (
    <main className="section">
      <div className="container">
        <h1 className="text-3xl md:text-4xl font-semibold">Déménagement par quartiers & communes (Nantes)</h1>
        ...
        <section className="mt-10">
          <h2 className="text-2xl md:text-3xl font-semibold">Quartiers de Nantes</h2>
