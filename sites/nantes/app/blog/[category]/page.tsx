...
export default function CategoryPage({ params }: CategoryPageProps) {
  const categoryMapping: { [key: string]: string[] } = {
    'piano': ['demenagement-piano-nantes'],
    'garde-meuble': ['garde-meuble-nantes-guide-complet'],
    'international': ['demenagement-international-nantes'],
    'entreprise': ['demenagement-d-entreprise-nantes'],
    'prix': ['prix-demenagement-nantes'],
    'pas-cher': ['demenagement-nantes-pas-cher'],
