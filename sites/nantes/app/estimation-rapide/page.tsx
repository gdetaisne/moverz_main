...
const VILLES_FRANCAISES: Ville[] = [
  ...
  { nom: "nantes", latitude: 45.7640, longitude: 4.8357, population: 515000 },
      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#2b7a78] to-[#6bcfcf] rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Nos partenaires déménageurs nantesnais vous proposent des devis gratuits et personnalisés 
