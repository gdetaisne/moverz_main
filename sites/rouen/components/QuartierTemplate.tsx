...
export default function QuartierTemplate(props: {
  ...
  const { title, intro, priceRows, parentLink = "/devis-demenagement-Rouen/", coverImage } = props;
  return (
    <main className="section">
      <div className="container">
        <h1 className="text-3xl md:text-4xl font-semibold">
          Devis de déménagement – {title} (Rouen)
        </h1>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <aside className="card-glass rounded-2xl p-6">
            ...
            <a href="/estimation-demenagement-Rouen/" className="mt-4 inline-flex h-11 items-center justify-center rounded-2xl bg-[#2b7a78] px-5 text-sm font-medium text-white shadow-marketing-xl hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 transition duration-300">
