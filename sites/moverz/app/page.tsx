...
export const metadata: Metadata = {
  ...
  description:
    "Comparez 5+ devis de déménageurs contrôlés (solvabilité + 0 litige) sur toute la France. IA analyse → devis comparables. 100% gratuit, sans harcèlement téléphonique.",
  alternates: {
...
export default function Home() {
  const shortFaq = [
    ...
    },
    {
      ...
      a: "Non. Votre dossier reste anonyme : vous décidez vous‑même qui vous contacte et quand.",
    },
  ];
