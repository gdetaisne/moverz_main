...
**Tests postes utilisateurs** : 10-20 postes échantillons (connexions domaine, accès applications, imprimantes, téléphones IP)
...
**Surcoûts** : Heures supplémentaires dimanche nuit si retards tests (techniciens +50% nuit, 100€/h vs 60€/h jour)
...
Techniciens certifiés obligatoires (vs déménageurs standards pannes 80%, pertes données). Continuité : basculement cloud temporaire 48h (emails, ERP, web = 500-1000€ interruption 0h) vs migration classique 12-36h down acceptable PME non-critiques. Consultez [planification](/blog/satellites/planification-demenagement-bureaux-lyon), [prix](/blog/satellites/prix-demenagement-entreprise-lyon). Bonne migration IT !
