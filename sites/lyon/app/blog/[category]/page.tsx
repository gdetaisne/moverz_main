...
const categoryDescriptions: { [key: string]: string } = {
  'etudiant': 'Tous nos guides et conseils pour réussir votre déménagement étudiant à lyon : astuces budget, aides financières, et solutions pratiques.',
  'entreprise': 'Guides complets pour organiser votre déménagement d\'entreprise à lyon : planification, logistique, et conseils professionnels.',
  'piano': 'Conseils d\'experts pour déménager votre piano à lyon en toute sécurité : tarifs, techniques, et précautions.',
  'international': 'Tout savoir sur le déménagement international depuis lyon : formalités, transport, et organisation.',
  'longue-distance': 'Guides pratiques pour vos déménagements longue distance depuis lyon : préparation, coûts, et astuces.',
  'pas-cher': 'Astuces et conseils pour déménager à petit prix à lyon sans compromettre la qualité.',
  'urgent': 'Solutions et conseils pour organiser un déménagement urgent à lyon dans les meilleures conditions.',
  'devis': 'Guides pour comprendre et obtenir les meilleurs devis de déménagement à lyon.',
  'garde-meuble': 'Tout savoir sur les solutions de garde-meuble à lyon : tarifs, options, et conseils.',
  'prix': 'Guides détaillés sur les prix de déménagement à lyon pour tous types de projets.',
  'prix-piano': 'Informations complètes sur les tarifs de déménagement de piano à lyon.'
};
...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  return {
    title: `${categoryLabel} - Blog Déménagement lyon`,
...
export default function CategoryPage({ params }: CategoryPageProps) {
  const categoryMapping: { [key: string]: string[] } = {
    'piano': ['demenagement-piano-lyon'],
    'garde-meuble': ['garde-meuble-lyon-guide-complet'],
    'international': ['demenagement-international-lyon'],
    'entreprise': ['demenagement-d-entreprise-lyon'],
    'prix': ['prix-demenagement-lyon'],
    'pas-cher': ['demenagement-lyon-pas-cher'],
