...
export const metadata = generateLocalPageMetadata("Lyon", "Lyon");

const LyonData = {
  zone: "Lyon",
  zoneDisplay: "Lyon",
  description: "Service professionnel de déménagement dans le centre de Lyon",
  stats: {
    dossiers: "+120",
    demenageurs: "20",
    delai: "3-5"
  },
  pourquoiMoverz: "Lyon se classe en tête des villes françaises où il fait bon vivre en famille avec une note de 19/20 selon Le Figaro. Notre équipe d'experts déménageurs connaît parfaitement les spécificités de la ville : rues étroites du centre historique, contraintes de stationnement, immeubles anciens avec escaliers. Nous vous accompagnons dans votre projet de déménagement avec des déménageurs locaux certifiés qui maîtrisent les accès et les particularités de chaque quartier lyonnais.",
  ...
  partenaires: [
    ...
    {
      name: "Atlantique Lyon Déménagements",
      rating: 4.5,
      reviews: 66,
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement à Lyon ?",
      answer: "Nos partenaires déménageurs à Lyon peuvent généralement intervenir sous 7 jours. Pour les déménagements urgents, certains peuvent se libérer en 48h selon la période."
    },
    {
      question: "Comment se déroule l'accès au logement à Lyon ?",
      answer: "Nos déménageurs connaissent parfaitement les contraintes lyonnaises : rues étroites, stationnement limité, immeubles anciens. Ils s'adaptent aux créneaux autorisés et optimisent les horaires."
    },
    {
      question: "Quels sont les tarifs pour un déménagement à Lyon ?",
    ...
    },
    {
      ...
      answer: "Tous nos partenaires déménageurs à Lyon sont certifiés et assurés. Nous vérifions régulièrement leur couverture d'assurance et leur qualité de service."
    },
    {
      question: "Peut-on déménager le week-end à Lyon ?",
    ...
    {
      question: "Comment préparer mon déménagement à Lyon ?",
