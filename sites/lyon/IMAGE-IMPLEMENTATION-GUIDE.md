# 📸 Guide d'Implémentation des Images - Moverz lyon
...
**Images requises** :
- `/images/blog/cover-guide-lyon.jpg`
...
### Alt Text Format
`[Action/Sujet] — [Contexte local lyon] [Détails accès]`
...
1. **[Unsplash](https://unsplash.com/)**
   - Recherches : `lyon architecture`, `moving boxes`, `apartment interior`
...
### Photos Locales lyon
- **Flickr** : Recherche `lyon chartrons`, `place de la bourse`
- **Wikimedia Commons** : Photos libres de droits lyon
