...
/**
 * Correction des liens 404 dans Lyon
...
// Guides principaux avec category: "demenagement-lyon"
const guides = Object.values(mapping).filter(item => item.category === 'demenagement-lyon');
