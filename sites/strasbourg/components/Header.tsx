      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6 py-2 flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col leading-tight text-left">
            <span className="text-white uppercase font-extrabold tracking-tight text-sm md:text-base">Strasbourg</span>
            <span className="text-white/90 uppercase font-semibold tracking-[0.08em] text-[10px] md:text-xs">Devis Déménageur</span>
          </div>
        </Link>
