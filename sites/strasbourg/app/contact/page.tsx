...
export const metadata: Metadata = {
  title: 'Contact Déménagement strasbourg | Devis Gratuits | Moverz',
  description: 'Contactez nos experts déménageurs à strasbourg. Estimation gratuite en 30 min, 5 devis précis sous 7 jours.',
};
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            ...
            alt="Contactez notre équipe de déménagement à strasbourg"
          ...
          <div className="bg-white/5 backdrop-blur rounded-2xl p-6 border border-white/10">
            ...
            <div className="space-y-4 text-white/80">
              <div>
                ...
                <a href="mailto:contact@devis-demenageur-strasbourg.fr" className="text-[#6bcfcf] hover:text-[#6bcfcf]/80 transition-colors">
                  contact@devis-demenageur-strasbourg.fr
                </a>
              </div>
              <div>
