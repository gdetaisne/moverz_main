...
export const metadata: Metadata = {
  ...
  description:
    `Toutes les réponses sur le déménagement à ${city.nameCapitalized} : prix, volume en m³, cartons, quartiers difficiles, autorisations de stationnement, périodes, etc.`,
  alternates: {
