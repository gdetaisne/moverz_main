...
function cleanSlug(originalSlug: string, category: string): string {
  ...
  const cleanPatterns = [
    ...
    { from: /^demenagement-etudiant-/, to: '' },
    { from: /^demenagement-entreprise-/, to: '' },
    { from: /^demenagement-piano-/, to: '' },
    { from: /^demenagement-international-/, to: '' },
    { from: /^demenagement-longue-distance-/, to: '' },
    { from: /^demenagement-pas-cher-/, to: '' },
    { from: /^demenagement-urgent-/, to: '' },
    { from: /^devis-demenagement-/, to: '' },
    { from: /^garde-meuble-/, to: '' },
    { from: /^prix-demenagement-/, to: '' },
    { from: /^prix-demenagement-piano-/, to: '' },
    { from: /^prix-garde-meuble-/, to: '' },
    // Ensuite, retirer les patterns partiels en début
    { from: /^stockage-etudiant/, to: 'stockage-etudiant' },
    { from: /^cartons-gratuits/, to: 'cartons-gratuits' },
    { from: /^camion-demenagement-etudiant/, to: 'camion-demenagement-etudiant' },
    { from: /^assurance-demenagement-international/, to: 'assurance-demenagement-international' },
    { from: /^prix-demenagement-international/, to: 'prix-demenagement-international' },
    { from: /^emballage-demenagement-international/, to: 'emballage-demenagement-international' },
    { from: /^formalites-douanieres-demenagement-international/, to: 'formalites-douanieres-demenagement-international' },
    // Retirer "" en milieu de slug
    { from: /-/, to: '-' },
    // Retirer "" en fin
    { from: /$/, to: '' },
