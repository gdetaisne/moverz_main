...
export const metadata: Metadata = {
  title: {
    default: `Déménagement Bordeaux Pas Cher | Devis Gratuit | -40% 2024`,
    template: `%s | Déménageur Bordeaux`,
  },
  description:
    `Déménagement Bordeaux : comparez 5 devis en 2min. Prix transparents dès 290€. Économisez 40%. ✓ Gratuit ✓ Déménageurs Gironde certifiés ✓ Sans engagement.`,
