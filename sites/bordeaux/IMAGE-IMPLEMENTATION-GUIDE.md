# 📸 Guide d'Implémentation des Images - Moverz bordeaux
...
- ✅ Mockup IA avec overlay bordeaux
...
**Images requises** :
- `/images/blog/cover-guide-bordeaux.jpg`
...
### Alt Text Format
`[Action/Sujet] — [Contexte local bordeaux] [Détails accès]`
...
1. **[Unsplash](https://unsplash.com/)**
   - Recherches : `bordeaux architecture`, `moving boxes`, `apartment interior`
...
### Photos Locales bordeaux
- **Flickr** : Recherche `bordeaux chartrons`, `place de la bourse`
- **Wikimedia Commons** : Photos libres de droits bordeaux
