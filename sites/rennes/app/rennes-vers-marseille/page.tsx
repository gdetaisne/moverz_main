...
const marseilleData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "900-1300€",
      description: "Déménagement rennes → Marseille : 660 km, 7h00. Studio/T1 (10-15 m³) dès 900-1300€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "1300-2000€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement rennes → Marseille ?",
    ...
    {
      question: "Quels sont les tarifs pour rennes → Marseille ?",
