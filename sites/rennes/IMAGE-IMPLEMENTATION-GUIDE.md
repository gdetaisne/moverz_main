# 📸 Guide d'Implémentation des Images - Moverz rennes
...
**Images requises** :
- `/images/blog/cover-guide-rennes.jpg`
...
- [ ] **Hero** : `hero-ai-mockup.jpg` (16:9, ~150KB)
  ...
  - Filigrane rennes (Place de la Bourse)
...
### Alt Text Format
`[Action/Sujet] — [Contexte local rennes] [Détails accès]`
...
1. **[Unsplash](https://unsplash.com/)**
   - Recherches : `rennes architecture`, `moving boxes`, `apartment interior`
...
### Photos Locales rennes
- **Flickr** : Recherche `rennes chartrons`, `place de la bourse`
- **Wikimedia Commons** : Photos libres de droits rennes
