...
const espagneData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "600-900€",
      description: "Déménagement Marseille → Espagne : 200-400 km, variable. Studio/T1 (10-15 m³) dès 600-900€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "900-1400€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement Marseille → Espagne ?",
    ...
    {
      question: "Quels sont les tarifs pour Marseille → Espagne ?",
