...
const toulouseData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "400-600€",
      description: "Déménagement marseille → Toulouse : 245 km, 2h30. Studio/T1 (10-15 m³) dès 400-600€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "600-900€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement Marseille → Toulouse ?",
    ...
    {
      question: "Quels sont les tarifs pour Marseille → Toulouse ?",
