...
const MarseilleData = {
  ...
  destinationsFrequentes: [
    ...
    {
      href: "/Marseille-vers-nantes",
      title: "Marseille → Nantes",
  ...
  partenaires: [
    ...
    {
      name: "Atlantique Marseille Déménagements",
      rating: 4.5,
      reviews: 66,
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement à Marseille ?",
      answer: "Nos partenaires déménageurs à Marseille peuvent généralement intervenir sous 7 jours. Pour les déménagements urgents, certains peuvent se libérer en 48h selon la période."
    },
    {
      question: "Comment se déroule l'accès au logement à Marseille ?",
    ...
    {
      question: "Quels sont les tarifs pour un déménagement à Marseille ?",
    ...
    },
    {
      ...
      answer: "Tous nos partenaires déménageurs à Marseille sont certifiés et assurés. Nous vérifions régulièrement leur couverture d'assurance et leur qualité de service."
    },
    {
      question: "Peut-on déménager le week-end à Marseille ?",
    ...
    {
      question: "Comment préparer mon déménagement à Marseille ?",
