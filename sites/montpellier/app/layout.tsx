...
export const metadata: Metadata = {
  title: {
    default: `Déménageur Montpellier dès 295€ | Devis Gratuit 2min | -40%`,
    template: `%s | Déménagement Montpellier`,
  },
  description:
    `Déménagement Montpellier : 5 devis en 2min. Prix dès 295€. Économisez 40%. ✓ 100% gratuit ✓ Déménageurs Hérault vérifiés ✓ Réponse rapide.`,
