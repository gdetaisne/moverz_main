          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <a href="/blog/demenagement-montpellier/" className="block text-[#6bcfcf] hover:text-[#6bcfcf]/80 transition-colors">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <a href="/quartiers-montpellier/" className="block text-[#6bcfcf] hover:text-[#6bcfcf]/80 transition-colors">
