...
const faqs: QA[] = [
  ...
  },
  {
    ...
    a: [
      `Les déménagements sont plus délicats dans le centre-ville historique (${QUARTIERS[0].title}, ${QUARTIERS[1].title}) où l'accès peut être limité et les livraisons réglementées. Anticipez l'autorisation de stationnement auprès de la mairie et les horaires de livraison.`
    ],
    category: "Prestations & logistique",
  },
  // Tarifs & paiement
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-white/90">
              ...
              <a className="underline text-[#6bcfcf] hover:text-[#6bcfcf]/80 transition-colors" href="/estimation-rapide/">outil d'estimation rapide</a>.
            </p>
          </div>
        </div>
      </section>
