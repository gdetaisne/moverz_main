        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-white/90">
              ...
              Chaque partenaire est sélectionné pour sa qualité de service, sa transparence tarifaire et sa connaissance du terrain montpelliérain.
            </p>
          </div>
        </div>
      </section>
        ...
        <Section>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="card-glass rounded-2xl p-6">
              ...
              <p className="text-white/80">
                Expertise du terrain montpelliérain : accès, stationnement, contraintes spécifiques à chaque quartier.
              </p>
            </div>
          </div>
        </Section>
