          ...
          <div className="bg-white/5 backdrop-blur rounded-2xl p-6 border border-white/10">
            ...
            <div className="space-y-4 text-white/80">
              <div>
                ...
                <a href="mailto:contact@devis-demenageur-toulousain.fr" className="text-[#6bcfcf] hover:text-[#6bcfcf]/80 transition-colors">
                  contact@devis-demenageur-toulousain.fr
                </a>
              </div>
              <div>
