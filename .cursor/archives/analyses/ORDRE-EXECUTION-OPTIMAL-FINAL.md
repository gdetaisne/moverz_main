...
```
3️⃣ Audit (15 min) : Identifier fichiers chevauchement P1-006-SEO-migration-canonicals-termine/P1-012-SEO-villes-hardcodees-en-cours
   └─> 70 fichiers touchés par 2 tâches

4️⃣ P1-006-SEO-migration-canonicals-termine + P1-012-SEO-villes-hardcodees-en-cours FUSIONNÉS (2h) : 1 commit au lieu de 2
...
**Commande** :
```bash
"Cursor, fusionne corrections P1-006-SEO-migration-canonicals-termine + P1-012-SEO-villes-hardcodees-en-cours en 1 commit"
```
...
```
6️⃣ P2-013-SEO-internal-linking-homepage-en-cours (1h30) : Screaming Frog + validation maillage
   └─> Baseline avant TASK-404-05

7️⃣ TASK-404-02 COMPLET (1h) : Accents + Nice
   └─> Finalise structure blog

8️⃣ P2-009-SEO-amelioration-en-cours (1h) : Rich Results Test
...
```
P1-006-SEO-migration-canonicals-termine ✅ → P2-013-SEO-internal-linking-homepage-en-cours ✅ → TASK-404-05 ✅
                ↓
         TASK-404-02 change cleanSlug()
                ↓
         URLs blog changent
                ↓
         ❌ Liens P2-013-SEO-internal-linking-homepage-en-cours cassés
         ❌ Corrections TASK-404-05 cassées
         ↓
         REFAIRE P2-013-SEO-internal-linking-homepage-en-cours (1h30)
...
### Scénario B : P1-006-SEO-migration-canonicals-termine et P1-012-SEO-villes-hardcodees-en-cours séparés

```
P1-006-SEO-migration-canonicals-termine (2h30) : Corrige quartiers-toulouse/page.tsx
     ↓ commit
...
### Scénario C : P2-013-SEO-internal-linking-homepage-en-cours AVANT P1-006-SEO-migration-canonicals-termine

```
P2-013-SEO-internal-linking-homepage-en-cours : Optimise liens internes (trailing slash inconsistant)
     ↓
P1-006-SEO-migration-canonicals-termine : Ajoute trailing slash partout
     ↓

Résultat :
❌ Liens P2-013-SEO-internal-linking-homepage-en-cours sans trailing slash
❌ P1-006-SEO-migration-canonicals-termine les modifie
