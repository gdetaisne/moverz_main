...
export const metadata: Metadata = {
  title: 'Contact Déménagement bordeaux | Devis Gratuits | Moverz',
  description: 'Contactez nos experts déménageurs à bordeaux. Estimation gratuite en 30 min, 5 devis précis sous 7 jours.',
};
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            ...
            alt="Contactez notre équipe de déménagement à bordeaux"
