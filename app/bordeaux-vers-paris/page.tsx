...
const parisData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "800-1200€",
      description: "Déménagement bordeaux → Paris : 580 km, 6h00. Studio/T1 (10-15 m³) dès 800-1200€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "1200-1800€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement bordeaux → Paris ?",
    ...
    {
      question: "Quels sont les tarifs pour bordeaux → Paris ?",
