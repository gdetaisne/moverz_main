...
export function generateCorridorPageMetadata(destination: string): Metadata {
  return {
    title: `Déménagement Montpellier → ${destination} — Comparez des devis | Moverz`,
    description: `Un seul dossier, 20 déménageurs qualifiés. 3 devis sous 7 jours pour Montpellier → ${destination}.`,
    alternates: {
      canonical: `https://www.montpellier-demenageur.fr/montpellier-vers-${destination.toLowerCase()}`,
    },
    openGraph: {
      title: `Déménagement Montpellier → ${destination} — Comparez des devis | Moverz`,
      description: `Un seul dossier, 20 déménageurs qualifiés. 3 devis sous 7 jours pour Montpellier → ${destination}.`,
      url: `https://www.montpellier-demenageur.fr/montpellier-vers-${destination.toLowerCase()}`,
      type: 'website',
    },
  };
}
...
export function generateCorridorPageJsonLd(destination: string) {
  return {
    ...
    "@type": "Service",
    "name": `Déménagement Montpellier → ${destination} — comparaison de devis`,
    "provider": {
      "@type": "Organization",
      "name": "Moverz"
    },
    "areaServed": `Montpellier → ${destination}`,
      ...
      <div className="min-h-screen bg-[#04163a]">
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-6 py-12">
            <div className="text-center">
              <h1 className="text-3xl md:text-5xl font-bold text-white mb-6">
                Déménagement Montpellier → {destination} : comparez des devis fiables
              </h1>
        ...
        <div className="container max-w-6xl mx-auto px-4 md:px-6 py-12">
          <h2 className="text-2xl font-bold text-white mb-8 text-center">
            Prix indicatifs Montpellier → {destination}
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="container max-w-4xl mx-auto px-4 md:px-6 py-12">
          <div className="bg-white/5 backdrop-blur rounded-2xl p-8 border border-white/10 text-center">
            <h2 className="text-xl font-semibold text-white mb-4">
              Vous déménagez depuis Montpellier ?
            </h2>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/services/demenagement-standard-montpellier"
                className="bg-[#6bcfcf]/20 text-[#6bcfcf] px-6 py-3 rounded-full hover:bg-[#6bcfcf]/30 transition-colors"
              >
                Service Standard
              </Link>
