...
export const metadata = {
  title: "Quartiers & communes — Déménagement à Rouen | IA & transparence",
  description:
    "Trouvez votre page quartier/commune pour estimer votre déménagement à Rouen : Centre-ville, Saint-Marc, Joli-Mai, Coteaux-Sud, Saint-Sever… Mérignac, Pessac, Talence, Bègles, Villenave-d’Ornon.",
};
...
function JsonLd() {
  const items = [
    ...QUARTIERS.map((q, i) => ({
      ...
      name: `Devis de déménagement – ${q.title} (Rouen)`,
    })),
    ...COMMUNES.map((c, i) => ({
      "@type": "ListItem",
