...
const lyonData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "750-1100€",
      description: "Déménagement bordeaux → Lyon : 550 km, 5h30. Studio/T1 (10-15 m³) dès 750-1100€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "1100-1700€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement bordeaux → Lyon ?",
    ...
    {
      question: "Quels sont les tarifs pour bordeaux → Lyon ?",
