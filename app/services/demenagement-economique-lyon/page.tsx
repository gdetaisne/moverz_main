          ...
          <div className="text-center">
            <Breadcrumbs 
              items={[
                ...
                { label: "Déménagement Économique", href: "/services/demenagement-economique-lyon" }
              ]}
            />
            <h1 className="mt-6 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              Déménagement Économique à lyon
            </h1>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-semibold text-white mb-6">
              Solution la plus abordable pour déménager à lyon
            </h2>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* Déménagement local */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <h3 className="text-xl font-semibold text-white mb-6 text-center">Déménagement local (lyon)</h3>
