...
const espagneData = {
  ...
  prixIndicatifs: [
    {
      type: "Studio/T1",
      prix: "600-900€",
      description: "Déménagement rouen → Espagne : 150-500 km, variable. Studio/T1 (10-15 m³) dès 600-900€. Devis gratuit sous 7j. Équipe pro, emballage inclus."
    },
    {
      type: "T2/T3",
      prix: "900-1400€",
  ...
  faq: [
    {
      question: "Quels sont les délais pour un déménagement rouen → Espagne ?",
    ...
    {
      question: "Quels sont les tarifs pour rouen → Espagne ?",
