...
export const metadata: Metadata = {
  title: "Comment ça marche ? Déménagement Lyon en 3 étapes | Moverz",
  description: "Découvrez notre processus simple pour déménager à Lyon : 1) Inventaire IA gratuit en 30 min 2) Recevez 3 devis sous 7j 3) Choisissez votre déménageur. 100% gratuit, sans engagement.",
  alternates: {
    canonical: `https://www.devis-demenageur-lyon.fr/comment-ca-marche`,
  },
  openGraph: {
    title: "Comment ça marche ? Déménagement Lyon simplifié | Moverz",
    description: "Processus simple et transparent : photos + IA + devis personnalisés. Déménagez sereinement à Lyon.",
    url: `https://www.devis-demenageur-lyon.fr/comment-ca-marche`,
    type: 'website',
  },
}
