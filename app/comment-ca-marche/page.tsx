...
export const metadata: Metadata = {
  title: "Comment ça marche ? Déménagement Rennes en 3 étapes | Moverz",
  description: "Découvrez notre processus simple pour déménager à Rennes : 1) Inventaire IA gratuit en 30 min 2) Recevez 3 devis sous 7j 3) Choisissez votre déménageur. 100% gratuit, sans engagement.",
  alternates: {
    canonical: `https://www.devis-demenageur-rennes.fr/comment-ca-marche`,
  },
  openGraph: {
    title: "Comment ça marche ? Déménagement Rennes simplifié | Moverz",
    description: "Processus simple et transparent : photos + IA + devis personnalisés. Déménagez sereinement à Rennes.",
    url: `https://www.devis-demenageur-rennes.fr/comment-ca-marche`,
    type: 'website',
  },
}
